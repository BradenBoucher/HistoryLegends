...
const SCREENS = { AUTH:"AUTH", HOME:"HOME", US_HISTORY:"US_HISTORY", REV_WAR:"REV_WAR", WW2:"WW2", CIVIL_WAR:"CIVIL_WAR", PRE_BATTLE:"PRE_BATTLE", UNIT_SELECT:"UNIT_SELECT", BATTLE:"BATTLE", SHOP:"SHOP" };
...
// ─── CIVIL WAR QUESTIONS ─────────────────────────────────────────────────────
const Q_SUMTER=[{text:"When did the bombardment of Fort Sumter occur?",options:["January 1861","April 12–14, 1861","July 1861","December 1860"],answer:1,explanation:"April 12–14, 1861 — the event that started the Civil War."},{text:"Where was Fort Sumter located?",options:["Virginia","Charleston Harbor, South Carolina","Washington D.C.","Gettysburg, Pennsylvania"],answer:1,explanation:"In Charleston Harbor — a federal fort in a seceded state."},{text:"Why is Fort Sumter considered the 'trigger event' for the Civil War?",options:["Lincoln was assassinated there","It transformed a political crisis into armed conflict","The largest battle occurred there","A foreign power attacked"],answer:1,explanation:"The bombardment turned the secession crisis into actual warfare."},{text:"How did both North and South respond to Fort Sumter?",options:["Both called for peace","Both issued calls for volunteers and mobilized","The South surrendered","Congress stayed neutral"],answer:1,explanation:"Both sides mobilized for war — expecting a short conflict."},{text:"Which cause of the Civil War is most directly connected to secession?",options:["Trade disputes with Britain","Slavery and federal vs state power over it","Religious differences","Disputes with Mexico"],answer:1,explanation:"Slavery and the question of federal authority drove secession."},{text:"What did Fort Sumter reveal about pre-war expectations?",options:["Everyone knew it would be long","Both sides expected a quick, easy victory","Only the South expected war","The military was fully prepared"],answer:1,explanation:"Neither side anticipated four years of devastating warfare."},{text:"How might Northern and Southern newspaper accounts of Sumter differ?",options:["They would be identical","Different audiences and purposes would shape emphasis and blame","Only the North had newspapers","Neither side covered it"],answer:1,explanation:"Source analysis: audience, purpose, and POV create different framings."},{text:"Compare Fort Sumter to Lexington and Concord. What's similar?",options:["Both were massive battles","Both turned political tensions into armed conflict","Both involved foreign powers","Both ended wars"],answer:1,explanation:"Both were small engagements that triggered full-scale wars."}];
const Q_BULLRUN=[{text:"When was the First Battle of Bull Run?",options:["April 1861","July 21, 1861","September 1861","January 1862"],answer:1,explanation:"July 21, 1861 — the first full-scale battle."},{text:"Who won the First Battle of Bull Run?",options:["Union","Confederacy","Stalemate","Both retreated"],answer:1,explanation:"A Confederate victory that shocked the North."},{text:"Why did Bull Run shatter pre-war expectations?",options:["It ended in minutes","It proved the war would be long and bloody","Both sides agreed to peace","Foreign powers intervened"],answer:1,explanation:"The chaotic Union retreat showed this would not be quick."},{text:"What Confederate general earned his famous nickname at Bull Run?",options:["Robert E. Lee","Thomas 'Stonewall' Jackson","J.E.B. Stuart","P.G.T. Beauregard"],answer:1,explanation:"Jackson stood 'like a stone wall.'"},{text:"How did Bull Run affect Union military organization?",options:["No changes","Led to major reorganization, training, and longer enlistments","The Union disbanded","Lincoln surrendered command"],answer:1,explanation:"The shock forced professionalization of the Union army."},{text:"How might a Confederate victory early in the war affect diplomacy?",options:["No diplomatic effect","It encouraged hopes of European recognition of the Confederacy","France allied with the Union","Britain declared war on both"],answer:1,explanation:"Confederate success fueled hopes for British or French recognition."},{text:"Can a battle be strategically inconclusive but psychologically decisive?",options:["No — only territory matters","Yes — Bull Run changed attitudes more than the strategic map","Psychology is irrelevant","Only casualties matter"],answer:1,explanation:"Bull Run's main impact was on morale and expectations."},{text:"What evidence from soldier letters would best show morale changes?",options:["Weather descriptions","Expressions of shock, disillusionment, or determination","Supply lists","Battle maps"],answer:1,explanation:"Personal reactions reveal psychological impact."}];
const Q_ANTIETAM=[{text:"When was the Battle of Antietam?",options:["July 1862","September 17, 1862","December 1862","March 1863"],answer:1,explanation:"September 17, 1862 — deadliest single day in American military history."},{text:"What grim record does Antietam hold?",options:["Longest battle","Deadliest single day (~23,000 casualties)","First naval battle","Largest surrender"],answer:1,explanation:"About 23,000 killed, wounded, or missing in one day."},{text:"What major policy did Lincoln announce after Antietam?",options:["The Homestead Act","The preliminary Emancipation Proclamation","The Gettysburg Address","The 13th Amendment"],answer:1,explanation:"Lincoln announced emancipation from a position of strength."},{text:"Why did Lincoln wait for a battlefield success before announcing emancipation?",options:["He forgot","To announce from strength rather than desperation","He opposed it","Congress required it"],answer:1,explanation:"Timing after a victory avoided looking desperate."},{text:"How could Antietam affect Confederate hopes for foreign recognition?",options:["No effect","An inconclusive result made European powers hesitant","Britain immediately allied","France declared neutrality"],answer:1,explanation:"Without a clear Confederate victory, European nations stayed out."},{text:"How can a battle end inconclusively yet have major consequences?",options:["It can't","Political and diplomatic effects can outweigh territorial outcomes","Only decisive victories matter","Inconclusive means no impact"],answer:1,explanation:"Antietam enabled the Emancipation Proclamation despite being a tactical draw."},{text:"What would you look for to evaluate a battlefield photograph from Antietam?",options:["Nothing — photos are accurate","Time, selection bias, staging, and intended message","Only the photographer's name","Whether it's in color"],answer:1,explanation:"Early war photography could be staged or selectively chosen."},{text:"Was Antietam's primary significance military, political, or international?",options:["Purely military","Political — it enabled emancipation and discouraged foreign intervention","Purely international","No significance"],answer:1,explanation:"Political impact outweighed the tactical draw."}];
const Q_GETTYSBURG_CW=[{text:"When was the Battle of Gettysburg?",options:["January 1863","July 1–3, 1863","September 1863","December 1863"],answer:1,explanation:"July 1–3, 1863 — three days of intense fighting."},{text:"Why do historians call Gettysburg a 'turning point'?",options:["The war ended there","It ended Lee's second invasion and shifted momentum","Lincoln was present","It was the first battle"],answer:1,explanation:"Lee's failed invasion marked the beginning of Confederate decline."},{text:"What famous failed assault occurred on Gettysburg's third day?",options:["Pickett's Charge","Sherman's March","The Battle of the Bulge","Washington's Crossing"],answer:0,explanation:"Pickett's Charge was a disastrous frontal assault across open ground."},{text:"How were Lee's invasion goals tied to political strategy?",options:["They weren't","A Northern victory could boost peace movements and win recognition","He wanted to capture Washington","He was retreating"],answer:1,explanation:"Lee hoped to erode Union willpower and attract European support."},{text:"What famous speech was delivered at Gettysburg months later?",options:["Emancipation Proclamation","The Gettysburg Address by Lincoln","Lee's surrender terms","Declaration of Independence"],answer:1,explanation:"Lincoln's Gettysburg Address redefined the war's purpose."},{text:"About how many total casualties at Gettysburg?",options:["5,000","23,000","46,000–51,000","100,000"],answer:2,explanation:"Combined 46,000–51,000 — the war's bloodiest battle."},{text:"How did Gettysburg combine with another Union victory that same week?",options:["It didn't","Vicksburg fell the next day — a devastating one-two punch","Antietam was refought","Lee surrendered"],answer:1,explanation:"Gettysburg + Vicksburg together shifted the war decisively."},{text:"Compare Gettysburg to Bull Run — what changed?",options:["Nothing","Battles grew far larger, deadlier, and more complex","The war got smaller","Technology played less role"],answer:1,explanation:"Massive escalation from Bull Run's clash to Gettysburg's 165,000-man engagement."}];
const Q_VICKSBURG=[{text:"When did the Siege of Vicksburg end?",options:["March 1863","July 4, 1863","September 1863","January 1864"],answer:1,explanation:"July 4, 1863 — day after Gettysburg."},{text:"Why was Vicksburg strategically important?",options:["Confederate capital","It controlled the Mississippi River, splitting the Confederacy","Largest army","Bordered Canada"],answer:1,explanation:"Controlling the Mississippi severed the South's supply artery."},{text:"Who commanded Union forces at Vicksburg?",options:["Sherman","McClellan","Ulysses S. Grant","Burnside"],answer:2,explanation:"Grant's 47-day siege forced surrender."},{text:"How long did the siege last?",options:["1 week","17 days","47 days","6 months"],answer:2,explanation:"47 grueling days."},{text:"What does 'splitting the Confederacy in two' mean?",options:["Political metaphor","River control severed western states from eastern supply","Land physically split","Two governments"],answer:1,explanation:"Texas, Arkansas, Louisiana cut off from the heartland."},{text:"How does a siege differ from battles in civilian impact?",options:["No civilian impact","Civilians suffer starvation, shelling, and disease","Always evacuated","Sieges are faster"],answer:1,explanation:"Vicksburg's civilians endured weeks of bombardment and hunger."},{text:"Why are Gettysburg and Vicksburg together the turning point?",options:["Neither was important","Together they ended Lee's invasion AND gave Union the Mississippi","Unrelated","Only Gettysburg mattered"],answer:1,explanation:"Two victories in two days crushed Confederate options."},{text:"What sources best prove the river was a 'lifeline'?",options:["Battle reports only","Maps, supply records, shipping logs, economic data","Soldier diaries only","Editorials only"],answer:1,explanation:"Multiple source types corroborate the river's importance."}];
const Q_SHERMANMARCH=[{text:"What was the route of Sherman's March to the Sea?",options:["New York to Boston","Atlanta to Savannah, Georgia","Washington to Richmond","Gettysburg to Appomattox"],answer:1,explanation:"A path of destruction through Georgia."},{text:"What was the strategic goal beyond defeating armies?",options:["Capture Jefferson Davis","Destroy infrastructure and war-making capacity","Build railroads","Recruit Southerners"],answer:1,explanation:"Sherman targeted the South's ability to sustain the war."},{text:"What does 'hard war' or 'total war' mean?",options:["Fighting harder","Targeting civilian infrastructure and economy to end the war faster","More soldiers","Night fighting"],answer:1,explanation:"Destroying railroads, factories, farms to collapse capacity."},{text:"How did Sherman's March differ from earlier strategies?",options:["It didn't","Earlier strategy sought battles; Sherman targeted economy and morale","Earlier was more destructive","Sherman avoided combat"],answer:1,explanation:"Shift from battle-seeking to systematic economic destruction."},{text:"What ethical debates does 'hard war' raise?",options:["None","Whether targeting civilian property is justified to shorten a war","Only military targets matter","Ethics don't apply"],answer:1,explanation:"Contemporaries debated whether destroying civilian resources was moral."},{text:"How did the March affect Confederate morale?",options:["Boosted it","Demonstrated the Confederacy couldn't protect its own territory","No effect","The South celebrated"],answer:1,explanation:"The inability to stop Sherman showed the Confederacy was collapsing."},{text:"What would civilian diaries along the route reveal?",options:["Nothing","Firsthand accounts of destruction — but potentially biased by trauma","Only military facts","Casualty counts"],answer:1,explanation:"Civilian sources are powerful but must be evaluated for bias."},{text:"Compare Sherman's strategy to strategic bombing in later wars.",options:["Nothing similar","Both target war-making capacity behind front lines","Identical weapons","Both purely defensive"],answer:1,explanation:"Same logic of destroying productive capacity to force surrender."}];
const Q_APPOMATTOX_CW=[{text:"When did Lee surrender to Grant at Appomattox?",options:["January 1865","April 9, 1865","July 1865","December 1865"],answer:1,explanation:"April 9, 1865 — effectively ending the Civil War."},{text:"Why is Appomattox 'the most significant' surrender?",options:["Only surrender","Lee's surrender set the precedent for all remaining forces","Grant surrendered too","Happened in Washington"],answer:1,explanation:"Other Confederate armies followed Lee's example."},{text:"How did Grant's terms reflect goals for postwar stability?",options:["Demanded executions","Generous — soldiers paroled, kept horses, officers kept sidearms","Unconditional imprisonment","Massive reparations"],answer:1,explanation:"Lenient terms aimed to ease reconciliation."},{text:"Why do surrender terms matter for postwar politics?",options:["They don't","Harsh terms breed resentment; generous terms ease reunification","Only winners matter","Never honored"],answer:1,explanation:"Treatment of the defeated shapes whether peace holds."},{text:"Is 'end of the war' a process or a single date?",options:["Ended instantly","Other armies surrendered over weeks; Reconstruction took years","April 9 was the only date","War never ended"],answer:1,explanation:"Military surrender was just the start of a long process."},{text:"What happened to Lincoln days after Appomattox?",options:["He retired","Assassinated on April 14, 1865","Traveled to Europe","Ran for third term"],answer:1,explanation:"Lincoln's assassination plunged the nation into crisis."},{text:"Compare Appomattox to Yorktown.",options:["Nothing in common","Both ended wars militarily, but political resolution took longer","Same armies","Both in April"],answer:1,explanation:"Both saw decisive surrenders followed by years of political settlement."},{text:"Is Appomattox best understood as military, political, or symbolic?",options:["Only military","All three — ended combat, began Reconstruction, symbolized reunification","Only symbolic","Only political"],answer:1,explanation:"Appomattox operates on all three levels simultaneously."}];

const CW_BATTLES=[
  {id:"sumter",name:"Fort Sumter",date:"Apr 1861",general:"Gen. Beauregard",icon:"💥",questions:Q_SUMTER,context:"The bombardment of Fort Sumter triggered the Civil War, transforming a political crisis into armed conflict.",enemies:[{name:"Rebel Artillery",hp:70,dmg:14,icon:"🔴"},{name:"SC Militia",hp:65,dmg:16,icon:"🟠"},{name:"Beauregard's Battery",hp:70,dmg:18,icon:"⭐"}]},
  {id:"bullrun_cw",name:"First Bull Run",date:"Jul 1861",general:"Gen. Beauregard",icon:"🏃",questions:Q_BULLRUN,context:"The first full-scale battle. A Confederate victory shattered expectations of a short war.",enemies:[{name:"Confederate Infantry",hp:75,dmg:16,icon:"🔴"},{name:"Stonewall's Brigade",hp:80,dmg:18,icon:"🟠"},{name:"Rebel Cavalry",hp:75,dmg:20,icon:"⭐"}]},
  {id:"antietam",name:"Battle of Antietam",date:"Sep 1862",general:"Gen. Lee",icon:"💀",boss:true,bossReviewDmg:10,questions:Q_ANTIETAM,context:"The deadliest single day in American military history. Lincoln used the result to announce the Emancipation Proclamation.",enemies:[{name:"Army of Northern Virginia",hp:110,dmg:22,icon:"🔴"},{name:"Lee's Veterans",hp:120,dmg:24,icon:"🟠"},{name:"Gen. Robert E. Lee",hp:130,dmg:28,icon:"👑"}]},
  {id:"gettysburg_cw",name:"Battle of Gettysburg",date:"Jul 1863",general:"Gen. Lee",icon:"⚔️",questions:Q_GETTYSBURG_CW,context:"Lee's failed invasion of the North. Pickett's Charge and 51,000 casualties marked the war's turning point.",enemies:[{name:"Rebel Infantry",hp:100,dmg:22,icon:"🔴"},{name:"Pickett's Division",hp:95,dmg:24,icon:"🟠"},{name:"Lee's Command",hp:110,dmg:26,icon:"⭐"}]},
  {id:"vicksburg",name:"Siege of Vicksburg",date:"Jul 1863",general:"Gen. Pemberton",icon:"🏰",questions:Q_VICKSBURG,context:"Grant's 47-day siege gave the Union control of the Mississippi, splitting the Confederacy in two.",enemies:[{name:"Vicksburg Garrison",hp:95,dmg:20,icon:"🔴"},{name:"Rebel Defenders",hp:90,dmg:22,icon:"🟠"},{name:"Pemberton's HQ",hp:100,dmg:24,icon:"⭐"}]},
  {id:"shermanmarch",name:"Sherman's March",date:"Nov 1864",general:"Gen. Hood",icon:"🔥",questions:Q_SHERMANMARCH,context:"Sherman's 'hard war' march from Atlanta to Savannah destroyed Confederate infrastructure and morale.",enemies:[{name:"Georgia Militia",hp:80,dmg:18,icon:"🔴"},{name:"Rebel Skirmishers",hp:85,dmg:20,icon:"🟠"},{name:"Confederate Rear Guard",hp:90,dmg:22,icon:"⭐"}]},
  {id:"appomattox_cw",name:"Appomattox",date:"Apr 1865",general:"Gen. Lee",icon:"🏳️",boss:true,bossReviewDmg:12,questions:Q_APPOMATTOX_CW,context:"Lee's surrender to Grant ended the Civil War. Generous terms aimed to begin reunification.",enemies:[{name:"Army of Northern Virginia",hp:130,dmg:24,icon:"🔴"},{name:"Lee's Last Guard",hp:120,dmg:26,icon:"🟠"},{name:"Gen. Robert E. Lee",hp:150,dmg:30,icon:"👑"}]},
];
const CW_MAP=[
  {id:"appomattox_cw",name:"Appomattox",date:"Apr 1865",general:"Lee",boss:"FINAL BOSS",icon:"🏳️"},
  {id:"shermanmarch",name:"Sherman's March",date:"Nov 1864",general:"Hood",icon:"🔥"},
  {id:"vicksburg",name:"Vicksburg",date:"Jul 1863",general:"Pemberton",icon:"🏰"},
  {id:"gettysburg_cw",name:"Gettysburg",date:"Jul 1863",general:"Lee",icon:"⚔️"},
  {id:"antietam",name:"Antietam",date:"Sep 1862",general:"Lee",boss:"BOSS",icon:"💀"},
  {id:"bullrun_cw",name:"Bull Run",date:"Jul 1861",general:"Beauregard",icon:"🏃"},
  {id:"sumter",name:"Fort Sumter",date:"Apr 1861",general:"Beauregard",icon:"💥"},
];
...
function MapScreen({onBack,onSelect,completed,mapData,battles,title}){const sR=useRef(null);useEffect(()=>{if(sR.current)sR.current.scrollTop=sR.current.scrollHeight;},[]);const m=mapData,ns=115,mh=m.length*ns+140,pw=340;const gX=i=>{const c=(m.length-1-i)%6;return[0.5,0.25,0.5,0.75,0.5,0.3][c];};const pts=m.map((_,i)=>({x:gX(i)*pw,y:70+i*ns}));
  ...
  return(<div style={{height:"100vh",display:"flex",flexDirection:"column",animation:"fadeIn 0.4s ease-out",background:"#2a2118"}}>
    ...
    <div ref={sR} style={{flex:1,overflowY:"auto",overflowX:"hidden",position:"relative"}}>
      ...
      <div style={{backgroundImage:"url(/bg/map-parchment.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundColor:"#C4A462",position:"relative",minHeight:mh+30}}>
        {/* Parchment grain */}
  ...
  return(
    <div style={{minHeight:"100vh",background:"linear-gradient(180deg,#0d0d1a 0%,#1a1a2e 40%,#16213e 100%)",color:"#E0E0E0",fontFamily:fonts.body,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:600,margin:"0 auto",padding:16,position:"relative",zIndex:1,minHeight:"100vh",display:"flex",flexDirection:"column"}}>
        {screen!==SCREENS.BATTLE&&screen!==SCREENS.REV_WAR&&screen!==SCREENS.WW2&&screen!==SCREENS.CIVIL_WAR&&<div style={{textAlign:"center",padding:"6px 0 8px",borderBottom:"1px solid rgba(255,255,255,0.04)",marginBottom:12}}><img src="/logo.png" alt="History Legends" style={{width:100,height:"auto",cursor:"pointer",filter:"drop-shadow(0 2px 6px rgba(255,215,0,0.15))"}} onClick={goMenu}/></div>}
        ...
        <div style={{flex:1}}>
          ...
          {screen===SCREENS.CIVIL_WAR&&<MapScreen onBack={()=>setScreen(SCREENS.US_HISTORY)} onSelect={b=>{setCB(b);setEra("civilwar");setScreen(SCREENS.PRE_BATTLE);}} completed={completed} mapData={CW_MAP} battles={CW_BATTLES} title="Civil War"/>}
          ...
          {screen===SCREENS.BATTLE&&<>
            ...
            {state.phase!==PHASES.VICTORY&&state.phase!==PHASES.DEFEAT&&state.pSquad&&state.eSquad&&<>
              ...
              {/* ═══ 3v3 BATTLEFIELD ═══ */}
              {(()=>{const pacificIds=["pearlharbor","midway","iwojima","okinawa"];const winterIds=["bulge"];const bgSrc=curEra==="ww2"?(pacificIds.includes(curBattle.id)?"/bg/ww2-pacific.jpg":winterIds.includes(curBattle.id)?"/bg/ww2-winter.jpg":"/bg/ww2-europe.jpg"):curEra==="civilwar"?"/bg/revwar.jpg":"/bg/revwar.jpg";return(
